...
// Only the shape (hanzi silhouette) and catalog position are known — reading,
// meaning, and breakdown stay hidden to preserve the incentive to collect it.
export function MysteryCardDetail({ hanzi, dexNumber, levelLabel, onClose, onPrev, onNext }: {
      ...
      <div
        ...
        <div className="flex flex-col items-center gap-2 py-4">
          <div className="hz font-black" aria-hidden="true"
            style={{ color: "transparent", WebkitTextStroke: `2px ${C.line}`, fontSize: 96, lineHeight: 1.1 }}>
            {hanzi}
          </div>
          ...
          <p className="ui text-xs text-center leading-relaxed max-w-xs pt-2" style={{ color: C.dim }}>
            ...
            it to reveal the reading, meaning, and story.
          </p>
        </div>
